...
log_root="$repo_dir/logs/libero_eval_100k_20260811"
video_root="$repo_dir/data/libero/eval_100k_20260811"
...
run_eval() {
    ...
    CUDA_VISIBLE_DEVICES="$server_gpu" XLA_PYTHON_CLIENT_PREALLOCATE=false "$server_python" "$server_script" \
        --port "$port" \
        policy:checkpoint \
...
run_eval \
    gpu0_seed43_step100000_all10_spatial \
    "$repo_dir/checkpoints/pi0_libero_low_mem_finetune/final_replay_seed43_ascending_nodebuginfs_tmux_restart_20260807/100000" \
    6 4 5 7 0 3 8 1 2 9

run_eval \
    gpu2_seed42_step100000_all10_spatial \
    "$repo_dir/checkpoints/pi0_libero_low_mem_finetune/final_replay_seed42_descending_nodebuginfs_tmux_restart_20260807/100000" \
    9 2 1 8 3 0 7 5 4 6
